...
export const de: Translation = {
  ...
  contractForm: {
    ...
    versicherungsnehmer: "Versicherungsnehmer",
    newVersicherungsnehmer: "Oder neuer Versicherungsnehmer",
    newVersicherungsnehmerPlaceholder: "Name der Person zum Anlegen",
    willCreateVersicherungsnehmer: "Eine neue Person „{{name}}“ wird als Versicherungsnehmer angelegt.",
    detectedVersicherungsnehmer: "Erkannt: {{name}}",
  ...
  versicherungsnehmer: {
    ...
    empty: "Noch keine Versicherungsnehmer. Füge einem Vertrag eine Person als Versicherungsnehmer hinzu.",
